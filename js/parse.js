...
function parseRate(raw) {
  ...
  // Балл упирается в края шкалы (0–10) ниже, при подсчёте score, а вот
  // подпись сохраняется целиком: «гениально+» — редчайшая оценка, и
  // сводить её к обычному «гениально» значит её потерять.
